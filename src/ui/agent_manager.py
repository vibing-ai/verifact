...
async def process_claims(claims: List[Any], 
                         main_msg: cl.Message,
    ...
    async def update_progress():
        ...
        await main_msg.update(content=f"Processing {completed_claims}/{total_claims} claims... {percent}%")
            ...
            try:
                ...
                if not evidence:
                    ...
                    evidence_content = await create_evidence_display(
                        evidence, 
                        detailed=show_detailed_evidence,
