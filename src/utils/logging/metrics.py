...
class MetricsTracker:
    ...
    def __init__(self, component: str):
        ...
        self._storage_ttl = int(os.environ.get("METRICS_STORAGE_TTL", str(60 * 60 * 24 * 90)))  # 90 days
    
    def track_accuracy(self, prediction: str, ground_truth: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def track_check_worthiness(self, 
        ...
        if len(predictions) != len(ground_truths) or not predictions:
            raise ValueError("Prediction and ground truth lists must be non-empty and of equal length")
