...
from src.verifact_agents.claim_detector.models import Entity, EntityType
    ...
    def extract_entities(self, text: str) -> list[Entity]:
        ...
        for pattern in date_patterns:
            for match in re.finditer(pattern, text):
                ...
                entities.append(Entity(text=date_text, type=EntityType.DATE, relevance=1.0))
        ...
        for pattern in money_patterns:
            for match in re.finditer(pattern, text):
                ...
                entities.append(Entity(text=money_text, type=EntityType.MONEY, relevance=1.0))
        ...
        for pattern in percent_patterns:
            for match in re.finditer(pattern, text):
                ...
                entities.append(Entity(text=percent_text, type=EntityType.PERCENT, relevance=1.0))
