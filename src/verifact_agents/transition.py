...
from src.verifact_agents.dto import Claim, DTOFactory, Evidence, Verdict
from src.verifact_agents.evidence_hunter.hunter import Evidence as LegacyEvidence
from src.verifact_agents.interfaces import (
    ClaimDetector,
    EvidenceHunter,
    IClaimDetector,
    IEvidenceHunter,
...
from src.verifact_agents.verdict_writer.writer import Verdict as LegacyVerdict
    ...
    class VerdictWriterAdapter(VerdictWriter):
        async def generate_verdict(
            ...
            legacy_verdict = await writer.generate_verdict(
                ...
                explanation_detail,
                citation_style,
                include_alternative_perspectives,
            )
...
def convert_to_legacy_claim(claim: Claim) -> LegacyClaim:
    ...
    from src.verifact_agents.claim_detector.models import ClaimDomain, Entity, EntityType
