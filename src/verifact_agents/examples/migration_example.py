...
from src.verifact_agents.claim_detector.models import Claim as LegacyClaim

# Import from new implementations
from src.verifact_agents.evidence_hunter.hunter import EvidenceHunter as LegacyEvidenceHunter
from src.verifact_agents.factory import AgentFactory
from src.verifact_agents.orchestrator import FactcheckPipeline
from src.verifact_agents.transition import (
    adapt_evidence_hunter,
    adapt_verdict_writer,
)
from src.verifact_agents.verdict_writer.writer import VerdictWriter as LegacyVerdictWriter
...
async def fully_migrated_workflow():
    ...
    config: dict[str, Any] = {
        ...
        "claim_detector": {},
        "evidence_hunter": {},
        "verdict_writer": {"explanation_detail": "detailed"},
    }

    # Create the fully migrated pipeline using the factory
    from src.verifact_agents.orchestrator import FactcheckPipelineFactory
